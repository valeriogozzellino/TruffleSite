...
export const bookedContentIt = {
  ...
  includedItems: [
    {
      title: "Guida Esperta e Cane Trifolau:",
      description:
    ...
    },
    {
      ...
      description:
        "Immortaliamo i momenti salienti della tua avventura per ricordi che dureranno una vita.",
    },
  ],
};
...
export const bookedContentEn = {
  ...
  includedItems: [
    ...
    },
    {
      ...
      description:
        "We capture the highlights of your adventure for memories that will last a lifetime.",
    },
  ],
};
